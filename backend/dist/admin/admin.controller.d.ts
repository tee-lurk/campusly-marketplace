...
export declare class AdminController {
    ...
    getRecentActivity(filter?: string, limit?: string): Promise<{
        id: string;
    ...
    getAllListings(search?: string, category?: string, page?: string): Promise<{
        data: ({
            category: {
                name: string;
                id: string;
    ...
    getUsers(search?: string, role?: string, page?: string): Promise<{
        data: {
            profile: {
                name: string;
                username: string;
    ...
    banUser(req: any, id: string, dto: BanUserDto): Promise<{
        email: string;
        id: string;
        is_banned: boolean;
        banned_reason: string | null;
    ...
    getTransactions(search?: string, status?: string, page?: string): Promise<{
        data: ({
            product: {
                seller: {
                    profile: {
    ...
    createProductType(dto: CreateProductTypeDto): Promise<{
        category: {
            name: string;
            id: string;
        };
    ...
    updateProductType(id: string, dto: UpdateProductTypeDto): Promise<{
        category: {
            name: string;
            id: string;
        };
